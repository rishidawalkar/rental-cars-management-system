...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    ...
    <h2><center>RentalCars Collection</center></h2>
...
$sql = "SELECT vehicle_type,vehicle,units_available from cars";
$result = $conn->query($sql);
if($result-> num_rows > 0){
    while($row = $result-> fetch_assoc()){
        echo "<tr><td>". $row['vehicle_type'] ."</td><td>". $row['vehicle'] ."</td><td>". $row['units_available'] ."</td></tr>" ;
    }
    echo "</table>";
}
$conn-> close();
